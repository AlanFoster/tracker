 ...
 */
export function Extras(hiddenInputAttributes: ExtrasProps) {
 ...
 * Mimics the rails equivalent. Please modify to your liking.
 */
export function CollectionRadioButtons({
  includeHidden,
  collection,
  label,
  errorKey,
 ...
 * Mimics the rails equivalent. Please modify to your liking.
 */
export function EmailField({ type: _type, ...rest }: EmailFieldProps) {
 ...
 * Mimics the rails equivalent. Please modify to your liking.
 */
export function ColorField({ type: _type, ...rest }: ColorFieldProps) {
 ...
 * Mimics the rails equivalent. Please modify to your liking.
 */
export function DateField({ type: _type, ...rest }: DateFieldProps) {
 ...
 * Mimics the rails equivalent. Please modify to your liking.
 */
export function SearchField({ type: _type, ...rest }: SearchFieldProps) {
 ...
 * Mimics the rails equivalent. Please modify to your liking.
 */
export function TelField({ type: _type, ...rest }: TelFieldProps) {
 ...
 * Mimics the rails equivalent. Please modify to your liking.
 */
export function UrlField({ type: _type, ...rest }: UrlFieldProps) {
 ...
 * Mimics the rails equivalent. Please modify to your liking.
 */
export function MonthField({ type: _type, ...rest }: MonthFieldProps) {
 ...
 * Mimics the rails equivalent. Please modify to your liking.
 */
export function TimeField({ type: _type, ...rest }: TimeFieldProps) {
 ...
 * Mimics the rails equivalent. Please modify to your liking.
 */
export function NumberField({ type: _type, ...rest }: NumberFieldProps) {
 ...
 * Mimics the rails equivalent. Please modify to your liking.
 */
export function RangeField({ type: _type, ...rest }: RangeFieldProps) {
 ...
 * Mimics the rails equivalent. Please modify to your liking.
 */
export function FileField({ type: _type, ...rest }: FileFieldProps) {
